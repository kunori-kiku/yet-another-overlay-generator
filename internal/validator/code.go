...
var registry = map[Code]string{
	...
	CodeNodePublicEndpointHostIllegalChars: "public_endpoints host {host} contains illegal characters: only letters, digits, dot (.), underscore (_), colon (:), brackets ([ ]), and hyphen (-) are allowed; whitespace and shell metacharacters are forbidden because the host is interpolated into root-executed install scripts.",
	...
	CodeEdgeEndpointHostIllegalChars:       "endpoint_host {host} contains illegal characters: only letters, digits, dot (.), underscore (_), colon (:), brackets ([ ]), and hyphen (-) are allowed; whitespace and shell metacharacters are forbidden because the host is interpolated into root-executed install scripts.",
